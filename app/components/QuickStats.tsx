  ...
  return (
    <div className="px-5 pt-6 pb-2 border-b-2">
      ...
      <div className="flex flex-wrap items-center gap-5 px-6 py-1">
        <div className="flex gap-4 justify-center lg:px-5 lg:py-4 lg:border-r-2">
        ...
        <div className="flex gap-4 justify-center lg:pr-3 lg:py-4 lg:border-r-2">
        ...
        <div className="flex gap-4 justify-center lg:px-2">
